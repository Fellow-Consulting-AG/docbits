...
* **Otwórz nowe okno:**
* **Cel:** Otwiera nowe okno do porównywania dokumentów obok siebie lub wykonywania wielozadaniowości.
...
* **Przypadek użycia:** Przydatne do udzielania opinii, instrukcji lub ważnych uwag innym członkom zespołu, którzy będą pracować nad dokumentem w przyszłości.
...
* **Przypadek użycia:** Przydatne w sytuacjach, gdy części dokumentu są skanowane oddzielnie i trzeba je skonsolidować.
