...
{% hint style="info" %}
Veja aqui adicionar [Script no DocBits](../admin-section/setup/scripting-in-docbits/)
{% endhint %}
...
Existem campos que são necessários para uma edição posterior, esses podem ser editados nas configurações.
