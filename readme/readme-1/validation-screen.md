...
{% hint style="info" %}
[DocBits'te Script Ekle](../admin-section/setup/scripting-in-docbits/) için buraya bakın
{% endhint %}
...
Bir belge üzerinde notlar bırakabilirsiniz. Bu, belgeyi daha sonra düzenleyecek diğer kullanıcılara bilgi bırakmak için faydalı olabilir.
...
Şirket içinde iletilen görevlerin aksine, bu destek bileti, hataları ve/veya tutarsızlıkları hemen bildirmek ve derhal bir bilet oluşturmak için önemlidir. Bu süreci çok daha kolay hale getirir çünkü hatayı hemen uygun belge ile gönderebilirsiniz. Ayrıca öncelik belirleme, belgenin ekran görüntüsünü alabilme veya yükleyebilme seçeneği de bulunmaktadır.

<figure><img src="../.gitbook/assets/Bildschirmfoto 2024-05-10 um 10.45.07.png" alt="" width="237"><figcaption></figcaption></figure>

### **Belge script Günlükleri:**
...
* Burada belgeyi bölebilir ve ihtiyaç duymadığınız sayfaları kesip silebilirsiniz
...
* Belgenin akışını bulabilirsiniz

### **Düzen Şablonuna Git:**

* Bu seçenekle yönlendirilecek ve düzeninizi düzenleyebilir veya varsayılan şablonu kullanabilirsiniz
...
Aşağıdakileri öğrenmek için araç ipucunu kullanın:&#x20;
...
Eğer bir sütun eksikse, burada yeni bir sütun oluşturabilirsiniz. Başlığı belirtin, zorunlu bir alan olup olmayacağına karar verin ve sütun tipini belirleyin (bu doğru formatta önemlidir)
