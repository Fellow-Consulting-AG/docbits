...
{% hint style="info" %}
Vedi qui [Script in DocBits](../admin-section/setup/scripting-in-docbits/)
{% endhint %}
...
Puoi lasciare annotazioni su un documento. Questo può essere utile per lasciare informazioni ad altri utenti che modificheranno ulteriormente questo documento.
...
* Troverai il flusso del documento
