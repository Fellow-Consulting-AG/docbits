...
{% hint style="info" %}
Hier Script in DocBits hinzufügen[ Script in DocBits](../admin-section/setup/scripting-in-docbits/)
{% endhint %}
...
* Geringes Vertrauen
* Vollständige Steuerbetrag-Unstimmigkeit

### **Zur Tabellenauswahlansicht gehen:**

<figure><img src="../.gitbook/assets/Bildschirmfoto 2024-05-10 um 11.35.37.png" alt=""><figcaption></figcaption></figure>

Hier gelangen Sie zur Tabellenauswahlansicht und haben weitere Optionen zur Fortsetzung. Zum Beispiel im Schulungsmodus das Erlernen der Tabelle.
...
### **Tabellenauswahl für diesen Lieferanten blockieren:**
