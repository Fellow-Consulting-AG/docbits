...
Aby udostępnić wewnętrzne informacje, możesz tworzyć zadania i przypisywać je konkretnemu pracownikowi lub grupie w firmie.
...
Możesz zostawić adnotacje na dokumencie. Może to być pomocne, aby zostawić informacje dla innych użytkowników, którzy dalej edytują ten dokument.
...
Dokumenty można tutaj scalować, na przykład jeśli brakowało strony faktury, te strony można później połączyć w ten sposób, bez konieczności usuwania całego dokumentu lub ponownego przesyłania.
...
W widoku OCR tekst jest automatycznie filtrowany z dokumentu. Jest to używane do rozpoznawania istotnych cech, takich jak kod pocztowy, numer umowy, numer faktury i sortowanie dokumentu.
...
Skrypty można tworzyć w ustawieniach w sekcji Typy Dokumentów; informacje te zostaną wyświetlone tutaj.
...
* Tutaj możesz podzielić dokument i wyciąć lub usunąć strony, których nie potrzebujesz
...
* Czy jest to pole obowiązkowe (wymagane)
* Wymagana walidacja&#x20;
* Niska pewność
...
Tutaj przejdziesz do widoku ekstrakcji tabeli i będziesz mieć dalsze opcje do kontynuacji. Na przykład, w trybie treningowym, ucząc się tabeli.
...
Jeśli brakuje kolumny, możesz tutaj utworzyć nową kolumnę. Określ tytuł, zdecyduj, czy powinno to być pole wymagane, i typ kolumny (to jest ważne dla poprawnego formatu)
