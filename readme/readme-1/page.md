...
Da biste delili interne informacije, možete kreirati zadatke i dodeliti ih određenom zaposlenom ili grupi unutar kompanije.
...
Možete ostaviti anotacije na dokumentu. Ovo može biti korisno kako biste ostavili informacije za druge korisnike koji dalje uređuju ovaj dokument.
...
Dokumenti se mogu spojiti ovde, na primer ako nedostaje stranica fakture, te stranice se mogu kasnije spojiti na ovaj način bez potrebe da ceo dokument bude obrisan ili ponovo otpremljen.
...
**Dnevnici skripti dokumenata:**

<figure><img src="../.gitbook/assets/Bildschirmfoto 2024-05-10 um 09.03.34.png" alt="" width="160"><figcaption></figcaption></figure>

Skripte se mogu kreirati u podešavanjima pod Tipovi dokumenata; ove informacije će se zatim prikazati ovde.
...
Postoje polja koja su obavezna za dalje uređivanje, ova se mogu urediti u podešavanjima.

Koristite alatku za savet da biste saznali da li:&#x20;

* Da li je polje obavezno (potrebno)
* Potrebna validacija&#x20;
* Niska pouzdanost
* Neusaglašenost punog iznosa poreza
