...
* [**Status der verbrauchten Bestellposition**](../../../../../administration-and-setup/settings/global-settings/document-types/more-settings/purchase-order/consumed-po-line-status.md): Diese Einstellung verbessert den Bestellnummer-Abgleichsbildschirm, indem Farbcodierungen auf die PO-Zeilen angewendet werden.
