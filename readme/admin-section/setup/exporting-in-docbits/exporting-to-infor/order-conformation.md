...
Pequena atualização para Confirmação do Pedido



{% hint style="info" %}
Link para o [Arquivo](../../../../../BOD-Mapping%20\(OrderConfirmation\).properties)
{% endhint %}
```
...
# Atributo IDM correspondente:
TN_InvoiceTable_TC_PURCHASE_ORDER=OrdemDeCompra
# Atributo IDM correspondente:
TN_InvoiceTable_TC_UNIT=UnidadeMedida
# Atributo IDM correspondente:
TN_InvoiceTable_TC_POSITION=Posição
# Atributo IDM correspondente:
TN_InvoiceTable_TC_SUB_LINE_NUMBER=NúmeroLinhaSecundária
# Atributo IDM correspondente:
TN_InvoiceTable_TC_UNIT_PRICE=PreçoUnitárioConfirmado
# Atributo IDM correspondente:
TN_InvoiceTable_TC_TOTAL_AMOUNT=ValorTotal
# Atributo IDM correspondente:
TN_InvoiceTable_TC_NET_AMOUNT=ValorLíquido
# Atributo IDM correspondente:
TN_InvoiceTable_TC_LIEFERDATUM=DataHoraEntregaPrometida
...
TNV_InvoiceTable_name=LinhasFatura
{% hint style="info" %}
Veja aqui uma [amostra](../../../../../M3_CaptureDocumentToProcessPurchaseOrder2.xml) do Fluxo de Trabalho do Infor OS - Atualizado em 11 de junho de 2024
{% endhint %}
