...
Kleines Update für Bestellbestätigung



{% hint style="info" %}
Link zur [Datei](../../../../../BOD-Mapping%20\(Bestellbestätigung\).properties)
{% endhint %}
```
...
#entsprechendes IDM-Attribut:
TN_InvoiceTable_TC_PURCHASE_ORDER=Bestellung
#entsprechendes IDM-Attribut:
TN_InvoiceTable_TC_UNIT=Messeinheit
#entsprechendes IDM-Attribut:
TN_InvoiceTable_TC_POSITION=Position
#entsprechendes IDM-Attribut:
TN_InvoiceTable_TC_SUB_LINE_NUMBER=Unterpositionsnummer
#entsprechendes IDM-Attribut:
TN_InvoiceTable_TC_UNIT_PRICE=BestätigterStückpreis
#entsprechendes IDM-Attribut:
TN_InvoiceTable_TC_TOTAL_AMOUNT=Betrag
#entsprechendes IDM-Attribut:
TN_InvoiceTable_TC_NET_AMOUNT=Nettobetrag
#entsprechendes IDM-Attribut:
TN_InvoiceTable_TC_LIEFERDATUM=ZugesagtesLieferdatum
...
TNV_InvoiceTable_name=Rechnungszeilen
{% hint style="info" %}
Hier finden Sie ein [Beispiel](../../../../../M3\_CaptureDocumentToProcessPurchaseOrder2.xml) Infor OS Workflow - Update 11. Juni 2024
{% endhint %}
