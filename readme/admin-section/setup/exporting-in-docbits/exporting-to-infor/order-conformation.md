...
Mała aktualizacja dla Potwierdzenia zamówienia



{% hint style="info" %}
Link do [Pliku](../../../../../BOD-Mapping%20\(OrderConfirmation\).properties)
{% endhint %}
```
...
#odpowiadający atrybut IDM:
TN_InvoiceTable_TC_PURCHASE_ORDER=NumerZamówienia
#odpowiadający atrybut IDM:
TN_InvoiceTable_TC_UNIT=JednostkaMiary
#odpowiadający atrybut IDM:
TN_InvoiceTable_TC_POSITION=Pozycja
#odpowiadający atrybut IDM:
TN_InvoiceTable_TC_SUB_LINE_NUMBER=NumerPodrzędny
#odpowiadający atrybut IDM:
TN_InvoiceTable_TC_UNIT_PRICE=PotwierdzonaCenaJednostkowa
#odpowiadający atrybut IDM:
TN_InvoiceTable_TC_TOTAL_AMOUNT=Kwota
#odpowiadający atrybut IDM:
TN_InvoiceTable_TC_NET_AMOUNT=KwotaNetto
#odpowiadający atrybut IDM:
TN_InvoiceTable_TC_LIEFERDATUM=DataDostawyZobowiązana
...
TNV_InvoiceTable_name=WierszeFaktury
{% hint style="info" %}
Zobacz tutaj [przykład](../../../../../M3\_CaptureDocumentToProcessPurchaseOrder2.xml) Infor OS Workflow - Aktualizacja 11 czerwca 2024
{% endhint %}
