...
Mala izmena za Potvrdu narudžbine



{% hint style="info" %}
Link ka [Fajlu](../../../../../BOD-Mapping%20\(OrderConfirmation\).properties)
{% endhint %}
```
...
#odgovarajući IDM atribut:
TN_InvoiceTable_TC_PURCHASE_ORDER=Narudžbenica
#odgovarajući IDM atribut:
TN_InvoiceTable_TC_UNIT=JedinicaMere
#odgovarajući IDM atribut:
TN_InvoiceTable_TC_POSITION=Pozicija
#odgovarajući IDM atribut:
TN_InvoiceTable_TC_SUB_LINE_NUMBER=BrojPodlinije
#odgovarajući IDM atribut:
TN_InvoiceTable_TC_UNIT_PRICE=PotvrđenaJediničnaCena
#odgovarajući IDM atribut:
TN_InvoiceTable_TC_TOTAL_AMOUNT=Iznos
#odgovarajući IDM atribut:
TN_InvoiceTable_TC_NET_AMOUNT=NetoIznos
#odgovarajući IDM atribut:
TN_InvoiceTable_TC_LIEFERDATUM=ObećaniDatumIsporuke
...
TNV_InvoiceTable_name=StavkeFakture
{% hint style="info" %}
Pogledajte ovde [uzorak](../../../../../M3\_CaptureDocumentToProcessPurchaseOrder2.xml) Infor OS Workflow - Ažuriranje 11. juna 2024.
{% endhint %}
