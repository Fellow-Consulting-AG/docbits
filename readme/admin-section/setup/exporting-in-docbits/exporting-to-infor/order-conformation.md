...
Petite mise à jour pour la Confirmation de commande



{% hint style="info" %}
Lien vers le [Fichier](../../../../../BOD-Mapping%20\(OrderConfirmation\).properties)
{% endhint %}
```
...
#Attribut IDM correspondant :
TN_InvoiceTable_TC_PURCHASE_ORDER=CommandeAchat
#Attribut IDM correspondant :
TN_InvoiceTable_TC_UNIT=UnitéMesure
#Attribut IDM correspondant :
TN_InvoiceTable_TC_POSITION=Position
#Attribut IDM correspondant :
TN_InvoiceTable_TC_SUB_LINE_NUMBER=NuméroSousLigne
#Attribut IDM correspondant :
TN_InvoiceTable_TC_UNIT_PRICE=PrixUnitaireConfirmé
#Attribut IDM correspondant :
TN_InvoiceTable_TC_TOTAL_AMOUNT=Montant
#Attribut IDM correspondant :
TN_InvoiceTable_TC_NET_AMOUNT=MontantNet
#Attribut IDM correspondant :
TN_InvoiceTable_TC_LIEFERDATUM=DateTimeLivraisonPromise
...
TNV_InvoiceTable_name=LignesFacture
{% hint style="info" %}
Voici un [exemple](../../../../../M3\_CaptureDocumentToProcessPurchaseOrder2.xml) de flux de travail Infor OS - Mise à jour le 11 juin 2024
{% endhint %}
