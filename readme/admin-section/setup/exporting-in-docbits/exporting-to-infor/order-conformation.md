...
Piccolo aggiornamento per la Conferma dell'Ordine



{% hint style="info" %}
Link al [File](../../../../../BOD-Mapping%20\(OrderConfirmation\).properties)
{% endhint %}
```
...
#Attributo IDM corrispondente:
TN_InvoiceTable_TC_PURCHASE_ORDER=OrdineAcquisto
#Attributo IDM corrispondente:
TN_InvoiceTable_TC_UNIT=MisuraUnitaria
#Attributo IDM corrispondente:
TN_InvoiceTable_TC_POSITION=Posizione
#Attributo IDM corrispondente:
TN_InvoiceTable_TC_SUB_LINE_NUMBER=NumeroSottoLinea
#Attributo IDM corrispondente:
TN_InvoiceTable_TC_UNIT_PRICE=PrezzoUnitarioConfermato
#Attributo IDM corrispondente:
TN_InvoiceTable_TC_TOTAL_AMOUNT=Importo
#Attributo IDM corrispondente:
TN_InvoiceTable_TC_NET_AMOUNT=ImportoNetto
#Attributo IDM corrispondente:
TN_InvoiceTable_TC_LIEFERDATUM=DataOraConsegnaPromessa
...
TNV_InvoiceTable_name=RigheFattura
{% hint style="info" %}
Ecco un [esempio](../../../../../M3\_CaptureDocumentToProcessPurchaseOrder2.xml) del Workflow di Infor OS - Aggiornato 11 giugno 2024
{% endhint %}
