...
Ecco un semplice esempio di come puoi utilizzare diverse funzioni in un piccolo script.
...
if iban_fuzzy and iban_extracted and iban_fuzzy != iban_extracted:
    set_field_as_invalid(document_data, "supplier_iban", "C'è una differenza nell'IBAN", "INVALID_VALUE")
