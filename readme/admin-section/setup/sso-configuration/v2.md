...
* Gehen Sie zu EINSTELLUNGEN (obere Leiste) und wählen Sie INTEGRATION, unter SSO Service Provider-Einstellungen finden Sie alle Informationen, die Sie für die folgenden Schritte benötigen.
...
| SSO-Endpunkt                 | Kopieren Sie die SSO-URL aus den SSO SERVICE-EINSTELLUNGEN und fügen Sie sie im SSO-Endpunktfeld ein.         |
| SLO-Endpunkt                 | Kopieren Sie die SLO-URL aus den SSO SERVICE-EINSTELLUNGEN und fügen Sie sie im SSO-Endpunktfeld ein.         |
...
* Klicken Sie auf die Option Identitätsanbieterinformationen anzeigen darunter.
...
\
Füllen Sie die folgenden Informationen aus, das URL-Feld ist die SSO-Endpunkt-URL aus dem Integrationsbereich in Ihren DocBits-Einstellungen. Es wird auch eine logische ID für Sie generiert, klicken Sie zum Speichern auf Speichern.&#x20;
...
* Gehen Sie zurück zum linken Menü in Infor und wählen Sie die Anwendung aus, die Sie gerade erstellt haben.
...
* Sie gelangen zum Dashboard von DocBits.
