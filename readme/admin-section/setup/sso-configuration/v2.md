...
| Punto de Inicio de SSO      | Copia la URL de SSO de la CONFIGURACIÓN DEL SERVICIO SSO y pégala en el campo Punto de Inicio de SSO.         |
...
Haz clic en OS en el menú izquierdo (como antes), serás llevado a un menú donde debes seleccionar Portal. Luego, haz clic en + Agregar Aplicación a la derecha.\
...
* Regresa al menú izquierdo en Infor y selecciona la aplicación que acabas de crear.
...
* Serás llevado al Tablero de DocBits.
