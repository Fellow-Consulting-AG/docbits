...
Ci-dessous, vous trouverez les mappages de champs nécessaires pour importer les données maîtresses, depuis Infor, dans DocBits.

## Comptabilité automatique (LN)
...
```
### FlexDimensions (Définition de code)
```javascript
{
