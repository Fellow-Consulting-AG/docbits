...
A continuación encontrarás los mapeos de campos necesarios para importar datos maestros, desde Infor, a DocBits.

## Contabilidad Automática (LN)
...
```
### DimensionesFlexibles (DefiniciónDeCódigo)
```javascript
{
