...
4. **Agregar y Gestionar Valores**: A través de la acción "Agregar Fila", puede introducir nuevos valores y sinónimos en las listas, y las "Acciones" permiten editar o eliminar entradas existentes.
