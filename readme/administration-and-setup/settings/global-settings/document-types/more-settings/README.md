...
* [**Estado de la línea de pedido consumida**](purchase-order/consumed-po-line-status.md): Esta configuración mejora la pantalla de coincidencia de la Orden de Compra aplicando codificación de colores a las líneas de la OC.
