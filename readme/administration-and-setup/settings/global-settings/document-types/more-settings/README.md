...
* [**Consumed PO line status**](purchase-order/consumed-po-line-status.md): This setting enhances the **Purchase Order Matching** screen by applying color coding to PO lines. It provides a quick visual understanding of the matching status for each line.
