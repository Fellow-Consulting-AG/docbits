# ZUGFeRD 2.3.2 Alan Eşleştirme

## Genel Bakış

ZUGFeRD 2.3.2, standardın ilk sürümüydü. Eski olmasına rağmen birçok belge hala bu formatı kullanmaktadır. DocBits, ZUGFeRD 2.3.2 XML dosyalarından veri çıkarmak için tam destek sağlar.
