# Mappatura dei campi ZUGFeRD 2.1 (Factur-X 1.0)

## Panoramica

ZUGFeRD 2.1 (Factur-X 1.0) è stata la versione iniziale dello standard. Sebbene sia datata, molti documenti utilizzano ancora questo formato. DocBits offre il supporto completo per l'estrazione dei dati dai file XML ZUGFeRD 2.1 (Factur-X 1.0).
