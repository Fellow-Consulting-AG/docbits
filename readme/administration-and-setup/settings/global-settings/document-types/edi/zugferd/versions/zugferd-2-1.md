# Mapeamento de campos ZUGFeRD 2.1 (Factur-X 1.0)

## Visão geral

O ZUGFeRD 2.1 (Factur-X 1.0) foi a versão inicial do padrão. Embora seja antiga, muitos documentos ainda usam esse formato. O DocBits oferece suporte total para a extração de dados de arquivos XML do ZUGFeRD 2.1 (Factur-X 1.0).
