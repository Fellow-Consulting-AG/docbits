# Mapowanie pól ZUGFeRD 2.3

## Przegląd

ZUGFeRD 2.3 był początkową wersją standardu. Choć jest to wersja starsza, wiele dokumentów nadal korzysta z tego formatu. DocBits zapewnia pełną obsługę wyodrębniania danych z plików XML ZUGFeRD 2.3.
