# Mapowanie pól ZUGFeRD 1.0

## Przegląd

ZUGFeRD 1.0 był początkową wersją standardu. Choć jest to wersja starsza, wiele dokumentów nadal korzysta z tego formatu. DocBits zapewnia pełną obsługę wyodrębniania danych z plików XML ZUGFeRD 1.0.
