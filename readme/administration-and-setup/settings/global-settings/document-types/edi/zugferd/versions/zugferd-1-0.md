# Mapeo de campos de ZUGFeRD 1.0

## Resumen

ZUGFeRD 1.0 fue la versión inicial del estándar. Aunque es antigua, muchos documentos todavía utilizan este formato. DocBits ofrece compatibilidad total para extraer datos de archivos XML de ZUGFeRD 1.0.
