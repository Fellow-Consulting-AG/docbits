# Mapeo de campos de ZUGFeRD 2.2

## Resumen

ZUGFeRD 2.2 fue la versión inicial del estándar. Aunque es antigua, muchos documentos todavía utilizan este formato. DocBits ofrece compatibilidad total para extraer datos de archivos XML de ZUGFeRD 2.2.
