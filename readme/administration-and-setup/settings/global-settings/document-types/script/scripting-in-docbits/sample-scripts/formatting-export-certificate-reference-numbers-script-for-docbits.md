# Script de Formato de Números de Referencia de Certificado de Exportación para Docbits

Este documento describe el script "Formatting Export Certificate Reference Numbers", destinado a estandarizar los números de referencia en certificados de exportación en Docbits. El formato adecuado asegura que los números de referencia cumplan con los requisitos de sistemas externos o regulaciones.

### Propósito

El objetivo principal del script es formatear números de referencia en certificados de exportación, asegurando que cumplan con un requisito de longitud predefinido rellenándolos con ceros a la izquierda. Esta consistencia ayuda a mantener un formato estandarizado para todos los documentos de exportación procesados a través de Docbits.
