...
<mark style="color:red;">Nota</mark>: Se o `DisplayID` não estiver disponível, o XPath alternativo `DocumentID/ID` será utilizado.
...
<mark style="color:red;">**Nota**</mark>: A quantidade faturada só será utilizada se o nó existir em UserArea com o nome InvoicedQuantity.
...
<mark style="color:red;">**Nota**</mark>: Se o XPath não estiver disponível, o XPath alternativo será utilizado.
