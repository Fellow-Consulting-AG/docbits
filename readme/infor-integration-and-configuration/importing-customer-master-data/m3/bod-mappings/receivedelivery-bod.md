...
<mark style="color:red;">Uwaga</mark>: Jeśli `DisplayID` jest niedostępny, zostanie użyta ścieżka XPath zastępcza `DocumentID/ID`.
...
<mark style="color:red;">**Uwaga**</mark>: Ilość zafakturowana będzie używana tylko wtedy, gdy węzeł istnieje w UserArea z nazwą InvoicedQuantity.
...
<mark style="color:red;">**Uwaga**</mark>: Jeśli ścieżka XPath jest niedostępna, zostanie użyta ścieżka XPath zastępcza.
