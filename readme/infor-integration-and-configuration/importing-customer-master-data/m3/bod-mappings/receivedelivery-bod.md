...
<mark style="color:red;">Nota</mark>: Se il `DisplayID` non è disponibile, verrà utilizzato l'XPath alternativo `DocumentID/ID`.
...
<mark style="color:red;">**Nota**</mark>: Se l'XPath non è disponibile, verrà utilizzato l'XPath alternativo.
