# ReceiveDelivery BOD-toewijzing
...
<mark style="color:red;">Opmerking</mark>: Als de `DisplayID` niet beschikbaar is, wordt het fallback-XPath `DocumentID/ID` gebruikt.
...
<mark style="color:red;">**Opmerking**</mark>: Factuuraantal wordt alleen gebruikt als het knooppunt bestaat in UserArea met de naam InvoicedQuantity.
...
<mark style="color:red;">**Opmerking**</mark>: Als het XPath niet beschikbaar is, wordt het fallback-XPath gebruikt.
