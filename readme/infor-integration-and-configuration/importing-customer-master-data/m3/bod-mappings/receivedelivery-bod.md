...
<mark style="color:red;">Hinweis</mark>: Wenn die `DisplayID` nicht verfügbar ist, wird der Fallback-XPath `DocumentID/ID` verwendet.
...
<mark style="color:red;">**Hinweis**</mark>: Die Rechnungsmenge wird nur verwendet, wenn der Knoten in UserArea mit dem Namen InvoicedQuantity vorhanden ist.
...
<mark style="color:red;">**Hinweis**</mark>: Wenn der XPath nicht verfügbar ist, wird der Fallback-XPath verwendet.
