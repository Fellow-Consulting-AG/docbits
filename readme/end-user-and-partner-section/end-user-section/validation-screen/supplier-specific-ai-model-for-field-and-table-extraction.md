...
Um das Modell zu ändern, öffnen Sie das Optionsmenü, indem Sie auf die **drei Punkte** auf der rechten Seite des Bildschirms klicken, und wählen Sie dann eines der verfügbaren Modelle:<br>

* **Full** – Kostet 2 Token
* **Fast** – Kostet 1 Token
* **Turbo** – Kostet 1 Token
