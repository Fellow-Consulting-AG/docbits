  ...
  * [Global Settings](administration-and-setup/settings/global-settings/README.md)
    ...
    * [Document Types](administration-and-setup/settings/global-settings/document-types/README.md)
      ...
      * [More Settings](administration-and-setup/settings/global-settings/document-types/more-settings/README.md)
        ...
        * [Approbation](administration-and-setup/settings/global-settings/document-types/more-settings/approbation/README.md)
          * [Cachet d'approbation](administration-and-setup/settings/global-settings/document-types/more-settings/approbation/approval-stamp.md)
        * [Commande d'achat](administration-and-setup/settings/global-settings/document-types/more-settings/commande-dachat/README.md)
          * [Table PO dans le Constructeur de Mise en Page](administration-and-setup/settings/global-settings/document-types/more-settings/commande-dachat/po-table-in-layout-builder.md)
          * [Vérification automatique des mises à jour de CA](administration-and-setup/settings/global-settings/document-types/more-settings/commande-dachat/auto-check-for-po-updates.md)
          * [Calculer le prix unitaire de la commande](administration-and-setup/settings/global-settings/document-types/more-settings/commande-dachat/calculate-po-unit-price.md)
          * [Paramètres de tolérance de commande d'achat / Tolérance de commande d'achat supplémentaire](administration-and-setup/settings/global-settings/document-types/more-settings/commande-dachat/purchase-order-tolerance-settings-additional-purchase-order-tolerance.md)
          * [Export des lignes de commande non appariées](administration-and-setup/settings/global-settings/document-types/more-settings/commande-dachat/export-not-matched-po-lines.md)
          * [Statuts de désactivation de commande d'achat](administration-and-setup/settings/global-settings/document-types/more-settings/commande-dachat/purchase-order-disable-statuses.md)
          * [Carte des Numéros d'Article Fournisseur - Documentation Administrateur](administration-and-setup/settings/global-settings/document-types/more-settings/commande-dachat/supplier-item-number-map-admin-documentation.md)
