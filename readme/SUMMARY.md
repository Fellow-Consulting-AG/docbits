...
* [Sección de usuario final](end-user-and-partner-section/end-user-section/README.md)
  ...
  * [Soporte para usuarios](end-user-and-partner-section/end-user-section/user-support.md)
  * [Opciones de Configuración del Usuario](end-user-and-partner-section/end-user-section/opciones-de-configuracion-del-usuario.md)
  * [Panel](end-user-and-partner-section/end-user-section/dashboard/README.md)
    ...
    * [Salir con ESC](end-user-and-partner-section/end-user-section/dashboard/leave-with-esc.md)
  ...
  * [Tareas](end-user-and-partner-section/end-user-section/tareas.md)
  * [Cuadro de mandos de envíos anticipados](end-user-and-partner-section/end-user-section/cuadro-de-mandos-de-envios-anticipados.md)
  * [Orden de Compra](end-user-and-partner-section/end-user-section/orden-de-compra.md)
  * [Panel de facturación](end-user-and-partner-section/end-user-section/panel-de-facturacion.md)
  ...
  * [Pantalla de Validación](end-user-and-partner-section/end-user-section/pantalla-de-validacion/README.md)
    * [Datos Difusos](end-user-and-partner-section/end-user-section/pantalla-de-validacion/datos-difusos.md)
    * [Códigos QR](end-user-and-partner-section/end-user-section/pantalla-de-validacion/codigos-qr.md)
  ...
  * [Conciliación de Órdenes de Compra](end-user-and-partner-section/end-user-section/purchase-order-matching/README.md)
    ...
    * [Mapa de número de artículo del proveedor](end-user-and-partner-section/end-user-section/purchase-order-matching/mapa-de-numero-de-articulo-del-proveedor.md)
  * [Contabilidad para Factura de Costos y Ventas Indirectas](end-user-and-partner-section/end-user-section/contabilidad-para-facturas-de-costos-y-ventas-indirectas.md)
...
* [Configuración](administration-and-setup/settings/README.md)
  * [Global Settings](administration-and-setup/settings/global-settings/README.md)
    ...
    * [Document Types](administration-and-setup/settings/global-settings/document-types/README.md)
      ...
      * [More Settings](administration-and-setup/settings/global-settings/document-types/more-settings/README.md)
        * [Mejores prácticas](administration-and-setup/settings/global-settings/document-types/more-settings/mejores-practicas.md)
        * [Propósito y uso](administration-and-setup/settings/global-settings/document-types/more-settings/proposito-y-uso.md)
        ...
        * [Solución de problemas](administration-and-setup/settings/global-settings/document-types/more-settings/solucion-de-problemas.md)
    ...
    * [Groups, Users and Permissions](administration-and-setup/settings/global-settings/groups-users-and-permissions/README.md)
      * [Grupos y Permisos](administration-and-setup/settings/global-settings/groups-users-and-permissions/groups-and-permissions/README.md)
        * [Propósito y Uso](administration-and-setup/settings/global-settings/groups-users-and-permissions/groups-and-permissions/proposito-y-uso.md)
        * [Agregar/Editar Grupos](administration-and-setup/settings/global-settings/groups-users-and-permissions/groups-and-permissions/agregar-editar-grupos.md)
        * [Activando Permisos](administration-and-setup/settings/global-settings/groups-users-and-permissions/groups-and-permissions/activando-permisos.md)
        * [Control de Acceso](administration-and-setup/settings/global-settings/groups-users-and-permissions/groups-and-permissions/control-de-acceso.md)
        * [Solución de problemas](administration-and-setup/settings/global-settings/groups-users-and-permissions/groups-and-permissions/solucion-de-problemas.md)
      * [Usuarios](administration-and-setup/settings/global-settings/groups-users-and-permissions/users/README.md)
        * [Modificando Detalles del Usuario](administration-and-setup/settings/global-settings/groups-users-and-permissions/users/modificando-detalles-del-usuario.md)
        * [Privilegios de Administrador](administration-and-setup/settings/global-settings/groups-users-and-permissions/users/privilegios-de-administrador.md)
      * [Suborganizaciones](administration-and-setup/settings/global-settings/groups-users-and-permissions/sub-organizations/README.md)
        * [Cómo crear una Suborganización](administration-and-setup/settings/global-settings/groups-users-and-permissions/sub-organizations/como-crear-una-suborganizacion.md)
  ...
  * [Procesamiento de documentos](administration-and-setup/settings/document-processing/README.md)
    ...
    * [Gestor de Reglas](administration-and-setup/settings/document-processing/gestor-de-reglas.md)
    ...
    * [Module](administration-and-setup/settings/document-processing/module/README.md)
      * [Modo de Anotación](administration-and-setup/settings/document-processing/module/annotation.md)
  ...
  * [Log Settings](administration-and-setup/settings/log-settings/README.md)
    * [Gestión de Tareas](administration-and-setup/settings/log-settings/gestion-de-tareas.md)
    * [Sincronización de Datos](administration-and-setup/settings/log-settings/sincronizacion-de-datos.md)
  * [Árboles de Decisión](administration-and-setup/settings/decision-trees.md)
  * [Configuración del Proveedor](administration-and-setup/settings/supplier-setting/README.md)
    ...
    * [Exportar Configuración para el Portal de Proveedores](administration-and-setup/settings/supplier-setting/export-configuration-for-supplier-portal.md)
...
* [Setup](administration-and-setup/setup/README.md)
  ...
  * [Portal de Proveedores](administration-and-setup/setup/portal-de-proveedores.md)
...
* [Exporting in DocBits](infor-integration-and-configuration/exporting-in-docbits/README.md)
  ...
  * [Exporting to INFOR](infor-integration-and-configuration/exporting-in-docbits/exporting-to-infor/README.md)
    * [Creating a BOD Mapping File](infor-integration-and-configuration/exporting-in-docbits/exporting-to-infor/creating-a-bod-mapping-file.md)
    * [Creando un Archivo de Mapeo IDM](infor-integration-and-configuration/exporting-in-docbits/exporting-to-infor/creating-an-idm-mapping-file.md)
    * [Creating an ION API Endpoint](infor-integration-and-configuration/exporting-in-docbits/exporting-to-infor/creating-an-ion-api-endpoint.md)
    * [Creating an ION API File](infor-integration-and-configuration/exporting-in-docbits/exporting-to-infor/creating-an-ion-api-file.md)
    * [Export to M3 Mapping (API)](infor-integration-and-configuration/exporting-in-docbits/exporting-to-infor/export-to-m3-mapping-api.md)
    * [Exporting to IDM](infor-integration-and-configuration/exporting-in-docbits/exporting-to-infor/exporting-to-idm.md)
    * [LN Configuration](infor-integration-and-configuration/exporting-in-docbits/exporting-to-infor/ln-configuration.md)
    * [M3 Configuration](infor-integration-and-configuration/exporting-in-docbits/exporting-to-infor/m3-configuration.md)
    * [Exportar Códigos de Impuestos a LN](infor-integration-and-configuration/exporting-in-docbits/exporting-to-infor/export-tax-codes-to-ln.md)
