  ...
  * [Global Settings](administration-and-setup/settings/global-settings/README.md)
    ...
    * [Document Types](administration-and-setup/settings/global-settings/document-types/README.md)
      ...
      * [More Settings](administration-and-setup/settings/global-settings/document-types/more-settings/README.md)
        ...
        * [Aprovação](administration-and-setup/settings/global-settings/document-types/more-settings/aprovacao/README.md)
          * [Selo de Aprovação](administration-and-setup/settings/global-settings/document-types/more-settings/aprovacao/approval-stamp.md)
        * [Ordem de compra](administration-and-setup/settings/global-settings/document-types/more-settings/ordem-de-compra/README.md)
          * [Tabela de PO no Construtor de Layout](administration-and-setup/settings/global-settings/document-types/more-settings/ordem-de-compra/po-table-in-layout-builder.md)
          * [Verificação automática de atualizações de PO](administration-and-setup/settings/global-settings/document-types/more-settings/ordem-de-compra/auto-check-for-po-updates.md)
          * [Calcular preço unitário do PO](administration-and-setup/settings/global-settings/document-types/more-settings/ordem-de-compra/calculate-po-unit-price.md)
          * [Exportar linhas de PO não correspondidas](administration-and-setup/settings/global-settings/document-types/more-settings/ordem-de-compra/export-not-matched-po-lines.md)
          * [Configurações de tolerância de pedido de compra / Tolerância adicional de pedido de compra](administration-and-setup/settings/global-settings/document-types/more-settings/ordem-de-compra/purchase-order-tolerance-settings-additional-purchase-order-tolerance.md)
          * [Status de desativação de pedido de compra](administration-and-setup/settings/global-settings/document-types/more-settings/ordem-de-compra/purchase-order-disable-statuses.md)
          * [Mapa de Números de Itens do Fornecedor - Documentação do Administrador](administration-and-setup/settings/global-settings/document-types/more-settings/ordem-de-compra/supplier-item-number-map-admin-documentation.md)
