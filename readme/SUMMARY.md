      ...
      * [Script](administration-and-setup/settings/global-settings/document-types/script/README.md)
        * [Scripting in DocBits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/README.md)
          ...
          * [Script di Esempio](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/README.md)
            * [Script per il Calcolo delle Spese Totali per Docbits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/calculating-total-charges-script-for-docbits-1.md)
            * [Script per il Calcolo delle Spese Totali per Docbits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/calculating-total-charges-script-for-docbits.md)
            * [Elimina righe con quantità e importo vuoti](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/delete-lines-with-empty-quantity-and-amount.md)
            * [Script per la Formattazione dei Numeri di Riferimento del Certificato di Esportazione per Docbits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/formatting-export-certificate-reference-numbers-script-for-docbits.md)
            * [Script per la Generazione di Numeri di Fattura Estesi per Docbits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/generating-extended-invoice-numbers-script-for-docbits-1.md)
            * [Script per la Generazione di Numeri di Fattura Estesi per Docbits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/generating-extended-invoice-numbers-script-for-docbits.md)
...
* [Configurazione](administration-and-setup/setup/README.md)
  ...
  * [Configurazione di WatchDog V2](administration-and-setup/setup/watchdog-v2-configuration.md)
