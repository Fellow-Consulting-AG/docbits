  ...
  * [Einstellungen](admin-section/settings/README.md)
    * [Globale Einstellungen](admin-section/settings/global-settings/README.md)
      ...
      * [Gruppen, Benutzer und Berechtigungen](admin-section/settings/global-settings/groups-users-and-permissions/README.md)
        * [Benutzer](admin-section/settings/global-settings/groups-users-and-permissions/users/README.md)
          * [Benutzerdetails bearbeiten](admin-section/settings-global-settings/groups-users-and-permissions/users/modifying-user-details.md)
          * [Admin-Privilegien](admin-section/settings-global-settings/groups-users-and-permissions/users/admin-privileges.md)
        * [Unterorganisationen](admin-section/settings-global-settings/groups-users-and-permissions/sub-organizations/README.md)
          * [Wie man eine Unterorganisation erstellt](admin-section/settings-global-settings/groups-users-and-permissions/sub-organizations/how-to-create-a-sub-organization.md)
        * [Gruppen und Berechtigungen](admin-section/settings-global-settings/groups-users-and-permissions/groups-and-permissions.md)
          * [Zweck und Verwendung](admin-section/settings-global-settings/groups-users-and-permissions/groups-and-permissions/purpose-and-use.md)
          * [Gruppen hinzufügen/bearbeiten](admin-section/settings-global-settings/groups-users-and-permissions/groups-and-permissions/adding-editing-groups.md)
          * [Berechtigungen aktivieren](admin-section/settings-global-settings/groups-users-and-permissions/groups-and-permissions/activating-permissions.md)
          * [Fehlerbehebung](admin-section/settings-global-settings/groups-users-and-permissions/groups-and-permissions/troubleshooting.md)
      ...
      * [Integration](admin-section/settings-global-settings/integration/README.md)
        * [API-Schlüssel](admin-section/settings-global-settings/integration/api-key.md)
        * [API-Aufrufe und Beispiele](admin-section/settings-global-settings/integration/api-calls-and-examples.md)
        * [API-Schlüsselverwaltung](admin-section/settings-global-settings/integration/api-key-management.md)
        * [Konfiguration von Single Sign-On (SSO)](admin-section/settings-global-settings/integration/configuring-single-sign-on-sso.md)
        * [Konfiguration des Identitätsdienstanbieters](admin-section/settings-global-settings/integration/identity-service-provider-configuration.md)
        * [Best Practices](admin-section/settings-global-settings/integration/best-practices.md)
        * [Fehlerbehebung bei häufigen Problemen](admin-section/settings-global-settings/integration/troubleshooting-common-issues.md)
