  ...
  * [Settings](admin-section/settings/README.md)
    * [Global Settings](admin-section/settings/global-settings/README.md)
      ...
      * [Document Types](admin-section/settings/global-settings/document-types/README.md)
        ...
        * [Save and apply changes](admin-section/settings/global-settings/document-types/save-and-apply-changes.md)
        ...
        * [Best practices](admin-section/settings/global-settings/document-types/best-practices-2.md)
        * [Troubleshooting](admin-section/settings/global-settings/document-types/troubleshooting-1-1.md)
        ...
        * [Configuring Field Properties](admin-section/settings/global-settings/document-types/configuring-field-properties-1.md)
        ...
        * [Editing and Saving Regex Patterns](admin-section/settings/global-settings/document-types/editing-and-saving-regex-patterns.md)
        * [Best practices](admin-section/settings/global-settings/document-types/best-practices-4.md)
        ...
        * [Troubleshooting](admin-section/settings/global-settings/document-types/troubleshooting-5.md)
        ...
        * [Best Practices](admin-section/settings/global-settings/document-types/best-practices-6.md)
