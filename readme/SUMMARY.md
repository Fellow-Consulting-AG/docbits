  ...
  * [Global Settings](administration-and-setup/settings/global-settings/README.md)
    ...
    * [Document Types](administration-and-setup/settings/global-settings/document-types/README.md)
      ...
      * [More Settings](administration-and-setup/settings/global-settings/document-types/more-settings/README.md)
        ...
        * [Zatwierdzenie](administration-and-setup/settings/global-settings/document-types/more-settings/zatwierdzenie/README.md)
          * [Stempel Zatwierdzenia](administration-and-setup/settings/global-settings/document-types/more-settings/zatwierdzenie/approval-stamp.md)
        * [Zamówienie](administration-and-setup/settings/global-settings/document-types/more-settings/zamowienie/README.md)
          * [Tabela PO w Kreatorze Układów](administration-and-setup/settings/global-settings/document-types/more-settings/zamowienie/po-table-in-layout-builder.md)
          * [Automatyczne sprawdzanie aktualizacji PO](administration-and-setup/settings/global-settings/document-types/more-settings/zamowienie/auto-check-for-po-updates.md)
          * [Oblicz cenę jednostkową PO](administration-and-setup/settings/global-settings/document-types/more-settings/zamowienie/calculate-po-unit-price.md)
          * [Eksport niepasujących linii PO](administration-and-setup/settings/global-settings/document-types/more-settings/zamowienie/export-not-matched-po-lines.md)
          * [Ustawienia tolerancji zamówienia zakupu / Dodatkowa tolerancja zamówienia zakupu](administration-and-setup/settings/global-settings/document-types/more-settings/zamowienie/purchase-order-tolerance-settings-additional-purchase-order-tolerance.md)
          * [Statusy wyłączenia zamówienia zakupu](administration-and-setup/settings/global-settings/document-types/more-settings/zamowienie/purchase-order-disable-statuses.md)
          * [Mapa Numerów Przedmiotów Dostawcy - Dokumentacja Administracyjna](administration-and-setup/settings/global-settings/document-types/more-settings/zamowienie/supplier-item-number-map-admin-documentation.md)
