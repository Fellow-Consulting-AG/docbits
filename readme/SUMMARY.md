...
* [Sekcja użytkownika końcowego](end-user-and-partner-section/end-user-section/README.md)
  * [Kluczowe funkcje DocBits](end-user-and-partner-section/end-user-section/key-features-of-docbits.md)
  * [Wsparcie Użytkownika](end-user-and-partner-section/end-user-section/user-support.md)
  ...
  * [Zadania](end-user-and-partner-section/end-user-section/zadania.md)
  * [Panel Kontroli Wysyłek Zaawansowanych](end-user-and-partner-section/end-user-section/panel-kontroli-wysylek-zaawansowanych.md)
  * [Zamówienie Zakupu](end-user-and-partner-section/end-user-section/zamowienie-zakupu.md)
  * [Dashboard Faktur](end-user-and-partner-section/end-user-section/dashboard-faktur.md)
  * [Panel Zamówień Wysyłkowych](end-user-and-partner-section/end-user-section/panel-zamowien-wysylkowych.md)
  * [Opcje Konfiguracji Użytkownika](end-user-and-partner-section/end-user-section/opcje-konfiguracji-uzytkownika.md)
  * [Tabela AI](end-user-and-partner-section/end-user-section/ai-table/README.md)
    * [Tagowanie tabeli AI](end-user-and-partner-section/end-user-section/ai-table/tagowanie-tabeli-ai.md)
  * [Ekran Walidacji](end-user-and-partner-section/end-user-section/ekran-walidacji/README.md)
    * [Rozmyte Dane](end-user-and-partner-section/end-user-section/ekran-walidacji/rozmyte-dane.md)
    * [Kody QR](end-user-and-partner-section/end-user-section/ekran-walidacji/kody-qr.md)
    * [Skróty Klawiaturowe](end-user-and-partner-section/end-user-section/ekran-walidacji/keyboard-shortcuts.md)
  * [Cel i Zastosowanie](end-user-and-partner-section/end-user-section/cel-i-zastosowanie.md)
  * [Dopasowywanie Zamówień Zakupu](end-user-and-partner-section/end-user-section/dopasowywanie-zamowien-zakupu/README.md)
    * [Automatyczne Dopasowywanie Danych Zamówień Zakupu](end-user-and-partner-section/end-user-section/dopasowywanie-zamowien-zakupu/automatyczne-dopasowywanie-danych-zamowien-zakupu.md)
    * [Mapa Numerów Przedmiotów Dostawcy](end-user-and-partner-section/end-user-section/dopasowywanie-zamowien-zakupu/mapa-numerow-przedmiotow-dostawcy.md)
    * [Skróty Klawiaturowe](end-user-and-partner-section/end-user-section/dopasowywanie-zamowien-zakupu/keyboard-shortcuts.md)
  * [Księgowanie faktur kosztowych i sprzedaży pośredniej](end-user-and-partner-section/end-user-section/ksiegowanie-faktur-kosztowych-i-sprzedazy-posredniej.md)
...
* [Ustawienia](administration-and-setup/settings/README.md)
  * [Global Settings](administration-and-setup/settings/global-settings/README.md)
    ...
    * [Document Types](administration-and-setup/settings/global-settings/document-types/README.md)
      ...
      * [More Settings](administration-and-setup/settings/global-settings/document-types/more-settings/README.md)
        * [Najlepsze praktyki](administration-and-setup/settings/global-settings/document-types/more-settings/najlepsze-praktyki.md)
        * [Cel i zastosowanie](administration-and-setup/settings/global-settings/document-types/more-settings/cel-i-zastosowanie.md)
    ...
    * [Groups, Users and Permissions](administration-and-setup/settings/global-settings/groups-users-and-permissions/README.md)
      * [Grupy i Uprawnienia](administration-and-setup/settings/global-settings/groups-users-and-permissions/groups-and-permissions/README.md)
        * [Cel i zastosowanie](administration-and-setup/settings/global-settings/groups-users-and-permissions/groups-and-permissions/cel-i-zastosowanie.md)
        * [Dodawanie/Edytowanie Grup](administration-and-setup/settings/global-settings/groups-users-and-permissions/groups-and-permissions/dodawanie-edytowanie-grup.md)
        * [Aktywacja uprawnień](administration-and-setup/settings/global-settings/groups-users-and-permissions/groups-and-permissions/aktywacja-uprawnien.md)
        * [Kontrola Dostępu](administration-and-setup/settings/global-settings/groups-users-and-permissions/groups-and-permissions/kontrola-dostepu.md)
        * [Rozwiązywanie problemów](administration-and-setup/settings/global-settings/groups-users-and-permissions/groups-and-permissions/rozwiazywanie-problemow.md)
      * [Podorganizacje](administration-and-setup/settings/global-settings/groups-users-and-permissions/sub-organizations/README.md)
        * [Jak utworzyć Podorganizację](administration-and-setup/settings/global-settings/groups-users-and-permissions/sub-organizations/jak-utworzyc-podorganizacje.md)
      * [Użytkownicy](administration-and-setup/settings/global-settings/groups-users-and-permissions/users/README.md)
        * [Modyfikowanie szczegółów użytkownika](administration-and-setup/settings/global-settings/groups-users-and-permissions/users/modyfikowanie-szczegolow-uzytkownika.md)
        * [Uprawnienia administratora](administration-and-setup/settings/global-settings/groups-users-and-permissions/users/uprawnienia-administratora.md)
    ...
    * [Pulpit](administration-and-setup/settings/global-settings/pulpit.md)
  * [Document Processing](administration-and-setup/settings/document-processing/README.md)
    ...
    * [Menedżer Reguł](administration-and-setup/settings/document-processing/menedzer-regul.md)
  ...
  * [Zarządzanie pamięcią podręczną](administration-and-setup/settings/zarzadzanie-pamiecia-podreczna.md)
  * [Ustawienia Dostawcy](administration-and-setup/settings/ustawienia-dostawcy/README.md)
  ...
  * [Log Settings](administration-and-setup/settings/log-settings/README.md)
    * [Zarządzanie Zadaniami](administration-and-setup/settings/log-settings/zarzadzanie-zadaniami.md)
    * [Synchronizacja Danych](administration-and-setup/settings/log-settings/synchronizacja-danych.md)
  * [Drzewa Decyzyjne](administration-and-setup/settings/decision-trees.md)
