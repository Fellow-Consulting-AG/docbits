...
* [Notes de version](overview-and-basics/release-notes.md)
    ...
    * [Types de Document](administration-and-setup/settings/global-settings/document-types/README.md)
      ...
      * [Script](administration-and-setup/settings/global-settings/document-types/script/README.md)
        * [Scripting dans DocBits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/README.md)
          * [Script de Calcul des Frais Totaux pour DocBits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/calculating-total-charges-script-for-docbits-1.md)
          * [Script de Calcul des Frais Totaux pour DocBits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/calculating-total-charges-script-for-docbits.md)
          * [Supprimer les lignes avec quantité et montant vides](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/delete-lines-with-empty-quantity-and-amount.md)
          * [Script de Formatage des Numéros de Référence de Certificats d'Exportation pour DocBits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/formatting-export-certificate-reference-numbers-script-for-docbits.md)
          * [Fonctions](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/functions.md)
          * [Script de Génération de Numéros de Facture Étendus pour DocBits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/generating-extended-invoice-numbers-script-for-docbits-1.md)
          * [Script de Génération de Numéros de Facture Étendus pour DocBits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/generating-extended-invoice-numbers-script-for-docbits.md)
