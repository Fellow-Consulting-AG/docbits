...
* [DocBits](README.md)
* [Sekcja użytkownika końcowego](end-user-section/README.md)
  * [Kluczowe funkcje DocBits](end-user-section/key-features-of-docbits.md)
  * [Wsparcie Użytkownika](end-user-section/user-support.md)
  * [Pulpit](end-user-section/dashboard/README.md)
    * [Narzędzia pulpitu nawigacyjnego](end-user-section/dashboard/dashboard-tools.md)
    * [Zmiana Kolumn Dokumentu](end-user-section/dashboard/change-document-columns.md)
    * [Scalanie Dokumentów](end-user-section/dashboard/document-merging.md)
    * [Status Dokumentu](end-user-section/dashboard/document-status.md)
    * [Filtrowanie Dokumentów](end-user-section/dashboard/filtering-documents.md)
    * [Dziennik Importu](end-user-section/dashboard/import-log.md)
    * [Wyjdź za pomocą ESC](end-user-section/dashboard/leave-with-esc.md)
  ...
  * [Panel Kontroli Wysyłek Zaawansowanych](end-user-section/panel-kontroli-wysylek-zaawansowanych.md)
  * [Zamówienie Zakupu](end-user-section/zamowienie-zakupu.md)
  * [Dashboard Faktur](end-user-section/dashboard-faktur.md)
  * [Panel Zamówień Wysyłkowych](end-user-section/panel-zamowien-wysylkowych.md)
  * [Opcje Konfiguracji Użytkownika](end-user-section/opcje-konfiguracji-uzytkownika.md)
  * [Tabela AI](end-user-section/ai-table/README.md)
    * [Tagowanie tabeli AI](end-user-section/ai-table/tagowanie-tabeli-ai.md)
  * [Ekran Walidacji](end-user-section/ekran-walidacji/README.md)
    * [Rozmyte Dane](end-user-section/ekran-walidacji/rozmyte-dane.md)
    * [Kody QR](end-user-section/ekran-walidacji/kody-qr.md)
  * [Cel i Zastosowanie](end-user-section/cel-i-zastosowanie.md)
  * [Dopasowywanie Zamówień Zakupu](end-user-section/dopasowywanie-zamowien-zakupu/README.md)
    * [Automatyczne Dopasowywanie Danych Zamówień Zakupu](end-user-section/dopasowywanie-zamowien-zakupu/automatyczne-dopasowywanie-danych-zamowien-zakupu.md)
    * [Mapa Numerów Przedmiotów Dostawcy](end-user-section/dopasowywanie-zamowien-zakupu/mapa-numerow-przedmiotow-dostawcy.md)
  * [Księgowanie faktur kosztowych i sprzedaży pośredniej](end-user-section/ksiegowanie-faktur-kosztowych-i-sprzedazy-posredniej.md)
  * [Jak importować dokumenty](end-user-section/how-to-import-documents/README.md)
    * [FTP](end-user-section/how-to-import-documents/ftp.md)
    * [Ręczny Import](end-user-section/how-to-import-documents/manual-import.md)
  ...
  * [Wsparcie techniczne w DocBits](end-user-section/technical-support-in-docbits/README.md)
    * [Utwórz zgłoszenie](end-user-section/technical-support-in-docbits/create-a-ticket.md)
    * [Ikony Pomocy](end-user-section/technical-support-in-docbits/help-icons.md)
  ...
  * [Portal Dostawcy](end-user-section/supplier-portal/README.md)
    * [Rejestracja Dostawcy](end-user-section/supplier-portal/supplier-registration.md)
    * [Status Dostawcy](end-user-section/supplier-portal/supplier-satuts.md)
  ...
  * [Ustawienia](overview/settings/README.md)
    * [Global Settings](overview/settings/global-settings/README.md)
      ...
      * [Document Types](admin-section/settings/global-settings/document-types/README.md)
        ...
        * [More Settings](admin-section/settings/global-settings/document-types/more-settings/README.md)
          ...
          * [Ustawienia tolerancji zamówienia zakupu / Dodatkowa tolerancja zamówienia zakupu](admin-section/settings/global-settings/document-types/more-settings/purchase-order-tolerance-settings-additional-purchase-order-tolerance.md)
          * [Statusy wyłączenia zamówienia zakupu](admin-section/settings/global-settings/document-types/more-settings/purchase-order-disable-statuses.md)
          * [Automatyczne sprawdzanie aktualizacji PO](admin-section/settings/global-settings/document-types/more-settings/auto-check-for-po-updates.md)
          * [Tabela PO w Kreatorze Układów](admin-section/settings/global-settings/document-types/more-settings/po-table-in-layout-builder.md)
    ...
    * [Document Processing](admin-section/settings/document-processing/README.md)
      ...
      * [Classification And Extraction](admin-section/settings/document-processing/classification-and-extraction/README.md)
        * [Ekstrakcja tabeli dla elementu kosztowego](admin-section/settings/document-processing/classification-and-extraction/table-extraction-for-costing-element.md)
  ...
  * [Setup](setup/README.md)
    ...
    * [Importing Master Data](setup/importing-customer-master-data/README.md)
      ...
      * [M3](setup/importing-customer-master-data/m3/README.md)
        ...
        * [Ekstrakcja tabeli dla elementu kosztowego](admin-section/setup/importing-customer-master-data/m3/table-extraction-for-costing-element.md)
    * [Exporting in DocBits](setup/exporting-in-docbits/README.md)
      ...
      * [Exporting to INFOR](setup/exporting-in-docbits/exporting-to-infor/README.md)
        ...
        * [Tworzenie pliku mapowania IDM](setup/exporting-in-docbits/exporting-to-infor/creating-an-idm-mapping-file.md)
    ...
    * [Skrypty w DocBits](setup/scripting-in-docbits/README.md)
      ...
      * [Funkcje](admin-section/setup/scripting-in-docbits/functions.md)
...
* [Sekcja Partnerów](partner-section/README.md)
  * [Automatyzacja Testów Faktur z DocBits](partner-section/invoice-automation-testing-with-docbits.md)
* [Ressources and Support](ressources-and-support.md)
* [Architektura](architecture/README.md)
  * [DocBits Infor na miejscu Klienta](architecture/docbits-infor-on-premise-customer.md)
  * [Certyfikaty](architecture/certifications.md)
* [Infor Infrastruktura](infor-infrastructure.md)
