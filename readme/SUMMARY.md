  ...
  * [Global Settings](administration-and-setup/settings/global-settings/README.md)
    ...
    * [Document Types](administration-and-setup/settings/global-settings/document-types/README.md)
      ...
      * [More Settings](administration-and-setup/settings/global-settings/document-types/more-settings/README.md)
        ...
        * [Approvazione](administration-and-setup/settings/global-settings/document-types/more-settings/approvazione/README.md)
          * [Timbro di approvazione](administration-and-setup/settings/global-settings/document-types/more-settings/approvazione/approval-stamp.md)
        * [Ordine di acquisto](administration-and-setup/settings/global-settings/document-types/more-settings/ordine-di-acquisto/README.md)
          * [Table PO dans le Constructeur de Mise en Page](administration-and-setup/settings/global-settings/document-types/more-settings/ordine-di-acquisto/po-table-in-layout-builder.md)
          * [Controllo automatico degli aggiornamenti PO](administration-and-setup/settings/global-settings/document-types/more-settings/ordine-di-acquisto/auto-check-for-po-updates.md)
          * [Calcolo del prezzo unitario dell'OP](administration-and-setup/settings/global-settings/document-types/more-settings/ordine-di-acquisto/calculate-po-unit-price.md)
          * [Esporta righe di PO non corrispondenti](administration-and-setup/settings/global-settings/document-types/more-settings/ordine-di-acquisto/export-not-matched-po-lines.md)
          * [Impostazioni di tolleranza per gli ordini di acquisto / Ulteriore tolleranza per gli ordini di acqui](administration-and-setup/settings/global-settings/document-types/more-settings/ordine-di-acquisto/purchase-order-tolerance-settings-additional-purchase-order-tolerance.md)
          * [Stati di disabilitazione degli ordini di acquisto](administration-and-setup/settings/global-settings/document-types/more-settings/ordine-di-acquisto/purchase-order-disable-statuses.md)
          * [Mappa dei Numeri di Articolo Fornitore - Documentazione Amministrativa](administration-and-setup/settings/global-settings/document-types/more-settings/ordine-di-acquisto/supplier-item-number-map-admin-documentation.md)
