      ...
      * [Skript](administration-and-setup/settings/global-settings/document-types/script/README.md)
        * [Skripterstellung in DocBits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/README.md)
          ...
          * [Beispielskripte](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/README.md)
            * [Skript zur Berechnung der Gesamtkosten für Docbits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/calculating-total-charges-script-for-docbits-1.md)
            * [Skript zur Berechnung der Gesamtkosten für Docbits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/calculating-total-charges-script-for-docbits.md)
            * [Zeilen mit leerer Menge und Betrag löschen](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/delete-lines-with-empty-quantity-and-amount.md)
            * [Skript zur Formatierung von Exportzertifikat-Referenznummern für Docbits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/formatting-export-certificate-reference-numbers-script-for-docbits.md)
            * [Skript zur Generierung erweiterter Rechnungsnummern für Docbits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/generating-extended-invoice-numbers-script-for-docbits-1.md)
            * [Skript zur Generierung erweiterter Rechnungsnummern für Docbits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/generating-extended-invoice-numbers-script-for-docbits.md)
