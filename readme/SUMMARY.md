...
* [Admin Section](admin-section/README.md)
  * [Settings](admin-section/settings/README.md)
    * [Global Settings](admin-section/settings/global-settings/README.md)
      ...
      * [Dashboard](admin-section/settings/global-settings/dashboard/README.md)
        * [Customizing Filters](admin-section/settings/global-settings/dashboard/customizing-filters.md)
    ...
    * [Document Expiry](admin-section/settings/document-expiry.md)
