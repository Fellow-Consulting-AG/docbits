...
* [Sekcja użytkownika końcowego](end-user-section/README.md)
  ...
  * [Pulpit](end-user-section/dashboard/README.md)
    ...
    * [Wyświetlanie zduplikowanych dokumentów](end-user-section/dashboard/wyswietlanie-zduplikowanych-dokumentow.md)
    * [Najlepsze Praktyki](end-user-section/dashboard/najlepsze-praktyki.md)
    * [Rozwiązywanie problemów](end-user-section/dashboard/rozwiazywanie-problemow.md)
