...
* [Sezione utente finale](end-user-section/README.md)
  ...
  * [Dashboard](end-user-section/dashboard/README.md)
    ...
    * [Risoluzione dei problemi](end-user-section/dashboard/troubleshooting.md)
...
* [Admin Section](admin-section/README.md)
  * [Impostazioni](overview/settings/README.md)
    ...
    * [Elaborazione Documenti](admin-section/settings/document-processing/README.md)
      ...
      * [Classificazione ed Estrazione](admin-section/settings/document-processing/classification-and-extraction/README.md)
        * [Estrazione della tabella per l'elemento di costo](admin-section/settings/document-processing/classification-and-extraction/table-extraction-for-costing-element.md)
      ...
      * [Module](admin-section/settings/document-processing/module/README.md)
        ...
        * [Aggiornamento IDM ACL](admin-section/settings/document-processing/module/idm-acl-updater.md)
    ...
    * [Alberi Decisionali](admin-section/settings/decision-trees.md)
  ...
  * [Setup](setup/README.md)
    ...
    * [Importing Master Data](setup/importing-customer-master-data/README.md)
      ...
      * [M3](setup/importing-customer-master-data/m3/README.md)
        ...
        * [Estrazione della tabella per l'elemento di costo](admin-section/setup/importing-customer-master-data/m3/table-extraction-for-costing-element.md)
    * [Exporting in DocBits](setup/exporting-in-docbits/README.md)
      ...
      * [Exporting to INFOR](setup/exporting-in-docbits/exporting-to-infor/README.md)
        ...
        * [Creazione di un file di mapping IDM](setup/exporting-in-docbits/exporting-to-infor/creating-an-idm-mapping-file.md)
        ...
        * [Esporta Codici Fiscali in LN](admin-section/setup/exporting-in-docbits/exporting-to-infor/export-tax-codes-to-ln.md)
    ...
    * [Scripting in DocBits](setup/scripting-in-docbits/README.md)
      ...
      * [Funzioni](admin-section/setup/scripting-in-docbits/functions.md)
...
* [Sezione Partner](partner-section/README.md)
  * [Automazione dei Test delle Fatture con DocBits](partner-section/invoice-automation-testing-with-docbits.md)
...
* [Architettura](architecture/README.md)
  ...
  * [Certificazioni](architecture/certifications.md)
* [Infor Infrastruttura](infor-infrastructure.md)
