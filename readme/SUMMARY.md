      ...
      * [Script](administration-and-setup/settings/global-settings/document-types/script/README.md)
        * [Programación en DocBits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/README.md)
          ...
          * [Scripts de Ejemplo](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/README.md)
            * [Script de Cálculo de Cargos Totales para Docbits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/calculating-total-charges-script-for-docbits-1.md)
            * [Script de Cálculo de Cargos Totales para Docbits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/calculating-total-charges-script-for-docbits.md)
            * [Eliminar líneas con cantidad y monto vacíos](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/delete-lines-with-empty-quantity-and-amount.md)
            * [Script de Formato de Números de Referencia de Certificado de Exportación para Docbits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/formatting-export-certificate-reference-numbers-script-for-docbits.md)
            * [Script de Generación de Números de Factura Extendidos para Docbits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/generating-extended-invoice-numbers-script-for-docbits-1.md)
            * [Script de Generación de Números de Factura Extendidos para Docbits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/generating-extended-invoice-numbers-script-for-docbits.md)
...
* [Configuración](administration-and-setup/setup/README.md)
  ...
  * [Configuración de WatchDog V2](administration-and-setup/setup/watchdog-v2-configuration.md)
