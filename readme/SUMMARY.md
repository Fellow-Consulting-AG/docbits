...
* [Sezione utente finale](end-user-and-partner-section/end-user-section/README.md)
  * [Caratteristiche principali di DocBits](end-user-and-partner-section/end-user-section/key-features-of-docbits.md)
  * [Supporto utenti](end-user-and-partner-section/end-user-section/user-support.md)
  * [Dashboard](end-user-and-partner-section/end-user-section/dashboard/README.md)
    * [Strumenti del Dashboard](end-user-and-partner-section/end-user-section/dashboard/dashboard-tools.md)
    ...
    * [Esci con ESC](end-user-and-partner-section/end-user-section/dashboard/leave-with-esc.md)
    ...
    * [Flusso Documento](end-user-and-partner-section/end-user-section/dashboard/flusso-documento.md)
  ...
  * [Attività](end-user-and-partner-section/end-user-section/attivita.md)
  * [Dashboard Spedizioni Anticipate](end-user-and-partner-section/end-user-section/dashboard-spedizioni-anticipate.md)
  * [Ordine di Acquisto](end-user-and-partner-section/end-user-section/ordine-di-acquisto.md)
  * [Dashboard Fatture](end-user-and-partner-section/end-user-section/dashboard-fatture.md)
  * [Dashboard Ordini di Spedizione](end-user-and-partner-section/end-user-section/dashboard-ordini-di-spedizione.md)
  * [Opzioni di Configurazione Utente](end-user-and-partner-section/end-user-section/opzioni-di-configurazione-utente.md)
  * [Tabella AI](end-user-and-partner-section/end-user-section/ai-table/README.md)
    * [Tag della tabella AI](end-user-and-partner-section/end-user-section/ai-table/tag-della-tabella-ai.md)
  * [Schermo di validazione](end-user-and-partner-section/end-user-section/schermo-di-validazione/README.md)
    * [Dati Fuzzy](end-user-and-partner-section/end-user-section/schermo-di-validazione/dati-fuzzy.md)
    * [Codici QR](end-user-and-partner-section/end-user-section/schermo-di-validazione/codici-qr.md)
    * [Scorciatoie da Tastiera](end-user-and-partner-section/end-user-section/schermo-di-validazione/keyboard-shortcuts.md)
  * [Scopo e Utilizzo](end-user-and-partner-section/end-user-section/scopo-e-utilizzo.md)
  * [Abbinamento ordine di acquisto](end-user-and-partner-section/end-user-section/purchase-order-matching/README.md)
    ...
    * [Mappa Numero Articolo Fornitore](end-user-and-partner-section/end-user-section/purchase-order-matching/mappatura-del-numero-dellarticolo-del-fornitore.md)
    * [Scorciatoie da Tastiera](end-user-and-partner-section/end-user-section/purchase-order-matching/keyboard-shortcuts.md)
  * [Contabilità per fattura di costo e vendite indirette](end-user-and-partner-section/end-user-section/contabilita-per-fattura-di-costo-e-vendite-indirette.md)
...
* [Impostazioni](administration-and-setup/settings/README.md)
  * [Global Settings](administration-and-setup/settings/global-settings/README.md)
    ...
    * [Document Types](administration-and-setup/settings/global-settings/document-types/README.md)
      ...
      * [More Settings](administration-and-setup/settings/global-settings/document-types/more-settings/README.md)
        * [Migliori pratiche](administration-and-setup/settings/global-settings/document-types/more-settings/migliori-pratiche.md)
        * [Scopo e utilizzo](administration-and-setup/settings/global-settings/document-types/more-settings/scopo-e-utilizzo.md)
        * [Gestione delle Fatture Duplicati in DocBits](administration-and-setup/settings/global-settings/document-types/more-settings/duplicate-invoice-handling-in-docbits.md)
        * [Timbro di approvazione](administration-and-setup/settings/global-settings/document-types/more-settings/approval-stamp.md)
        * [Mappa dei Numeri di Articolo Fornitore - Documentazione Amministrativa](administration-and-setup/settings/global-settings/document-types/more-settings/mappa-dei-numeri-di-articolo-fornitore-documentazione-amministrativa.md)
    ...
    * [Groups, Users and Permissions](administration-and-setup/settings/global-settings/groups-users-and-permissions/README.md)
      * [Gruppi e Autorizzazioni](administration-and-setup/settings/global-settings/groups-users-and-permissions/groups-and-permissions/README.md)
        * [Scopo e Utilizzo](administration-and-setup/settings/global-settings/groups-users-and-permissions/groups-and-permissions/scopo-e-utilizzo.md)
        * [Aggiunta/Modifica dei Gruppi](administration-and-setup/settings/global-settings/groups-users-and-permissions/groups-and-permissions/aggiunta-modifica-dei-gruppi.md)
        * [Attivazione dei Permessi](administration-and-setup/settings/global-settings/groups-users-and-permissions/groups-and-permissions/attivazione-dei-permessi.md)
        * [Controllo Accessi](administration-and-setup/settings/global-settings/groups-users-and-permissions/groups-and-permissions/controllo-accessi.md)
        * [Risoluzione dei problemi](administration-and-setup/settings/global-settings/groups-users-and-permissions/groups-and-permissions/risoluzione-dei-problemi.md)
      * [Sotto-Organizzazioni](administration-and-setup/settings/global-settings/groups-users-and-permissions/sub-organizations/README.md)
        * [Come creare una Sotto-Organizzazione](administration-and-setup/settings/global-settings/groups-users-and-permissions/sub-organizations/come-creare-una-sotto-organizzazione.md)
      * [Utenti](administration-and-setup/settings/global-settings/groups-users-and-permissions/users/README.md)
        * [Modifica dei Dettagli Utente](administration-and-setup/settings/global-settings/groups-users-and-permissions/users/modifica-dei-dettagli-utente.md)
        * [Privilegi di Amministratore](administration-and-setup/settings/global-settings/groups-users-and-permissions/users/privilegi-di-amministratore.md)
  ...
  * [Gestione della Cache](administration-and-setup/settings/gestione-della-cache.md)
  * [Impostazione del Fornitore](administration-and-setup/settings/impostazione-del-fornitore/README.md)
    * [Impostazioni Generali del Fornitore](administration-and-setup/settings/impostazione-del-fornitore/impostazioni-generali-del-fornitore.md)
    * [Modifica dei Modelli di Email](administration-and-setup/settings/impostazione-del-fornitore/modifica-dei-modelli-di-email.md)
    * [Configurazione dell'esportazione per il Portale fornitori per M3](administration-and-setup/settings/impostazione-del-fornitore/esportazione-della-configurazione-per-il-portale-fornitori.md)
  ...
  * [Log Settings](administration-and-setup/settings/log-settings/README.md)
    * [Gestione delle Attività](administration-and-setup/settings/log-settings/gestione-delle-attivita.md)
    * [Sincronizzazione dei Dati](administration-and-setup/settings/log-settings/sincronizzazione-dei-dati.md)
  * [Alberi Decisionali](administration-and-setup/settings/decision-trees.md)
