  ...
  * [Global Settings](administration-and-setup/settings/global-settings/README.md)
    ...
    * [Document Types](administration-and-setup/settings/global-settings/document-types/README.md)
      ...
      * [More Settings](administration-and-setup/settings/global-settings/document-types/more-settings/README.md)
        ...
        * [Aprobación](administration-and-setup/settings/global-settings/document-types/more-settings/aprobacion/README.md)
          * [Sello de aprobación](administration-and-setup/settings/global-settings/document-types/more-settings/aprobacion/approval-stamp.md)
        * [Orden de compra](administration-and-setup/settings/global-settings/document-types/more-settings/orden-de-compra/README.md)
          * [Tabla de PO en el Constructor de Diseño](administration-and-setup/settings/global-settings/document-types/more-settings/orden-de-compra/po-table-in-layout-builder.md)
          * [Verificación automática de actualizaciones de OC](administration-and-setup/settings/global-settings/document-types/more-settings/orden-de-compra/auto-check-for-po-updates.md)
          * [Calcular el precio unitario del pedido](administration-and-setup/settings/global-settings/document-types/more-settings/orden-de-compra/calculate-po-unit-price.md)
          * [Exportar líneas de PO no coincidentes](administration-and-setup/settings/global-settings/document-types/more-settings/orden-de-compra/export-not-matched-po-lines.md)
          * [Ajuste de tolerancias de órdenes de compra / Tolerancia adicional de órdenes de compra](administration-and-setup/settings/global-settings/document-types/more-settings/orden-de-compra/purchase-order-tolerance-settings-additional-purchase-order-tolerance.md)
          * [Estados de desactivación de órdenes de compra](administration-and-setup/settings/global-settings/document-types/more-settings/orden-de-compra/purchase-order-disable-statuses.md)
          * [Mapa de Números de Artículos de Proveedores - Documentación para Administradores](administration-and-setup/settings/global-settings/document-types/more-settings/orden-de-compra/supplier-item-number-map-admin-documentation.md)
