      ...
      * [Script](administration-and-setup/settings/global-settings/document-types/script/README.md)
        * [Scripting no DocBits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/README.md)
          ...
          * [Scripts de Exemplo](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/README.md)
            * [Script de Cálculo de Encargos Totais para DocBits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/calculating-total-charges-script-for-docbits-1.md)
            * [Script de Cálculo de Encargos Totais para DocBits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/calculating-total-charges-script-for-docbits.md)
            * [Excluir Linhas com Quantidade e Valor Vazios](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/delete-lines-with-empty-quantity-and-amount.md)
            * [Script de Formatação de Números de Referência de Certificado de Exportação para DocBits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/formatting-export-certificate-reference-numbers-script-for-docbits.md)
            * [Script de Geração de Números de Fatura Estendidos para DocBits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/generating-extended-invoice-numbers-script-for-docbits-1.md)
            * [Script de Geração de Números de Fatura Estendidos para DocBits](administration-and-setup/settings/global-settings/document-types/script/scripting-in-docbits/sample-scripts/generating-extended-invoice-numbers-script-for-docbits.md)
